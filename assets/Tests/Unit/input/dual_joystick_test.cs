...
namespace Game.Tests.Unit.Inputs {
    ...
    internal sealed class MockViewLayerChannel : ViewLayerChannel {
        ...
        public new void Raise(ViewLayer newLayer) {
    ...
    internal sealed class MockShipInputChannel : ShipInputChannel {
        ...
        public new void RaiseThrust(float thrust) {
            LastThrust = thrust;
            ThrustCallCount++;
        }

        public new void RaiseAim(Vector2 aim) {
            LastAim = aim;
            AimCallCount++;
        }
