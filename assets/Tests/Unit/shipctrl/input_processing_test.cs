...
public class InputProcessing_Test
{
    ...
    public void c1_allows_physics_when_input_enabled()
    {
        ...
        // When: FixedUpdate runs
        var m = typeof(ShipControlSystem).GetMethod("FixedUpdate",
            BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly);
        Assert.IsNotNull(m);
        m.Invoke(_scs, null);
        Physics.Simulate(Time.fixedDeltaTime);
    ...
    public void c3_thrust_uses_magnitude_not_raw_direction()
    {
        ...
        _rb.linearVelocity = Vector3.zero;
        SetField(_scs, "_lastThrustInput", Vector2.up * 1f);
    ...
    public void c4_aim_assist_blends_both_sticks()
    {
        ...
        SetField(_scs, "_lastAimInput", new Vector2(0.6f, 0f));
    ...
    public void c4_aim_assist_right_stick_contributes_half()
    {
        ...
        SetInput(0f, 0f, 1.0f);
        SetField(_scs, "_lastAimInput", new Vector2(1.0f, 0f));
        _rb.angularVelocity = Vector3.zero;
        _rb.rotation = Quaternion.identity;
    ...
    public void c4_deadzone_applies_to_both_sticks()
    {
        ...
        SetField(_scs, "_lastAimInput", new Vector2(0.5f, 0f));
        _rb.angularVelocity = Vector3.zero;
        _rb.rotation = Quaternion.identity;
    ...
    public void c4_left_stick_alone_produces_turn()
    {
        ...
        // Expected: 0.5 + 0 = 0.5
        SetInput(0f, 0.5f, 0f);
        SetField(_scs, "_lastAimInput", Vector2.zero);
        _rb.angularVelocity = Vector3.zero;
        _rb.rotation = Quaternion.identity;
