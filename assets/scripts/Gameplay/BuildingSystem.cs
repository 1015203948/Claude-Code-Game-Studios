...
using Game.Data;
using Game.Channels;
using ColonyMgr = Gameplay.ColonyManager;
...
namespace Game.Gameplay {
    ...
    public class BuildingSystem : MonoBehaviour
    {
        ...
        public BuildResult RequestBuild(string nodeId, BuildingType type)
        {
            ...
            if (!ColonyMgr.Instance.CanAffordResources(oreCost, energyCost)) {
            ...
            // Atomic deduction
            ColonyMgr.Instance.DeductResources(oreCost, energyCost);
        ...
        /// </summary>
        public void BuildShip(HullType hullType)
        {
    ...
    public readonly struct BuildResult
    {
        ...
        public static BuildResult Ok() => new BuildResult(true);
        public static BuildResult Failure(string reason) => new BuildResult(false, reason);
    }

    /// <summary>
    /// Result of a ship dispatch request.
    /// </summary>
    public readonly struct DispatchOrder
    {
        public bool IsValid { get; }
        public string FailReason { get; }

        public DispatchOrder(bool isValid, string failReason = null)
        {
            IsValid = isValid;
            FailReason = failReason;
        }

        public static DispatchOrder Invalid(string reason) => new DispatchOrder(false, reason);
    }
}
